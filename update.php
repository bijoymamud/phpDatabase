...
if (isset($_POST['submit'])) {
  ...
  $idupdate = $_GET['id'];
        ...
        $query = "UPDATE jobregistration SET `name`='$name', `qualification`='$qualification', `email`='$email', `number`='$number', `refference`='$reffer', `jobposition`='$jobposition' WHERE id=$idupdate";
...
if($res){
          ...
          ?>
				...
				<div class="col-span-full sm:col-span-3">
					...
					<input id="name" name="name" type="text" placeholder="Your Name" value="<?php echo $arradata['name'] ?>" class="w-full p-1 rounded-md focus:ring focus:ring-opacity-75 text-slate-600 dark:border-gray-300">
				</div>


				<div class="col-span-full sm:col-span-3">
					<label for="qualification" class="text-sm"></label>
					<input id="qualification" name="qualification" type="text"  placeholder="Your Qualification" value="<?php echo $arradata['qualification'] ?>" class="w-full p-1 rounded-md focus:ring focus:ring-opacity-75 text-slate-600 dark:border-gray-300">
				</div>


				<div class="col-span-full sm:col-span-3">
					<label for="email" class="text-sm"></label>
					<input id="email" name="email" type="email" placeholder="Enter email" value="<?php echo $arradata['email'] ?>" class="w-full p-1 rounded-md focus:ring focus:ring-opacity-75 text-slate-600  dark:border-gray-300">
				</div>


				<div class="col-span-full sm:col-span-3">
					<label for="number" class="text-sm"></label>
					<input id="number" name="number" type="number" placeholder="Your number" value="<?php echo $arradata['number'] ?>" class="w-full p-1 rounded-md focus:ring focus:ring-opacity-75 text-slate-600 focus:dark:ring-violet-600 dark:border-gray-300">
				</div>


				<div class="col-span-full sm:col-span-3">
					<label for="reffer" class="text-sm"></label>
					<input id="reffer" name="reffer" type="text" placeholder="Refference" value="<?php echo $arradata['refference'] ?>" class="w-full p-1 rounded-md focus:ring focus:ring-opacity-75 text-slate-600dark:border-gray-300">
				</div>
        ...
        <input type="submit" name="submit" class="text- w-[70px] mx-auto md:ms-[280px] text-white p-2 bg-indigo-400 rounded-lg col-span-full" value="Update">
